        ...
        >
          ...
          <motion.div variants={fadeInUp} className="flex items-center gap-2">
            ...
            <motion.button
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.96 }}
              className="flex items-center gap-2 rounded-lg bg-amber-500 px-4 py-2 text-sm font-semibold text-white hover:bg-amber-400 transition-all duration-200 shadow-[0_0_20px_rgba(99,102,241,0.3)]"
            >
            ...
            return (
              ...
              >
                ...
                <div className="mt-3 flex items-center gap-1.5">
                  ...
                  <span className={`text-xs font-semibold ${isPositive ? "text-amber-400" : "text-amber-400"}`}>
                  ...
                  <button
                    ...
                    className={`rounded-lg px-3 py-1.5 text-xs font-medium transition-all duration-200 ${
                      activePeriod === p.value
                        ? "bg-amber-500 text-white shadow-[0_0_12px_rgba(99,102,241,0.4)]"
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-500/10 border border-amber-500/20 text-xs font-bold text-amber-400">
                            {idx + 1}
                          </div>
                      ...
                      <td className="px-4 py-4 text-right">
                        <span className={`inline-flex items-center gap-1 text-xs font-semibold ${isPositiveTrend ? "text-amber-400" : "text-amber-400"}`}>
                          {isPositiveTrend ? (
