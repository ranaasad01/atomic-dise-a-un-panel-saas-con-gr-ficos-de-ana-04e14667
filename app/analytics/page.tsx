        ...
        >
          ...
          <motion.div variants={fadeInUp} className="flex items-center gap-2 shrink-0">
            ...
            <motion.button
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.97 }}
              className="flex items-center gap-2 rounded-xl bg-rose-600 hover:bg-rose-500 px-4 py-2 text-sm font-medium text-white transition-all duration-200 shadow-[0_0_20px_rgba(99,102,241,0.3)]"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-slate-300 focus:border-rose-500/50 focus:outline-none focus:ring-1 focus:ring-rose-500/30 transition-all"
                />
              ...
              {PERIODS.map((p) => (
                <motion.button
                  ...
                  className={`rounded-lg px-3 py-1.5 text-xs font-medium transition-all duration-200 ${
                    period === p.value
                      ? "bg-rose-600 text-white shadow-[0_0_12px_rgba(99,102,241,0.4)]"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                  ...
                  return (
                    <div key={s.source} className="flex items-center justify-between text-xs">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium text-rose-300 w-10 text-right">{pct}%</span>
                      </div>
                    </div>
                  );
                })}
          ...
          <Section className="lg:col-span-2">
            <div className="h-full rounded-2xl border border-white/8 bg-[#0F172A]/60 backdrop-blur-sm p-6 shadow-[0_1px_2px_rgba(0,0,0,0.2),0_8px_32px_-8px_rgba(0,0,0,0.5)]">
              ...
              <div className="mt-4 rounded-xl border border-rose-500/15 bg-rose-500/5 p-3">
                <p className="text-xs text-slate-400 leading-relaxed">
                  Las sesiones de más de 60 segundos tienen una tasa de conversión promedio del
                  <span className="font-semibold text-rose-300"> 58.4%</span>, frente al
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {[
                    ...
                    >
                      <td className="px-6 py-3.5 font-mono text-xs text-rose-300">{row.page}</td>
