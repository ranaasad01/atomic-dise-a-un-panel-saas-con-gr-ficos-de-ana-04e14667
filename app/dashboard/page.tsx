          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
            ...
            <div className="flex items-center gap-4 text-xs text-slate-400">
              <span className="flex items-center gap-1.5">
                <span className="h-2 w-4 rounded-full bg-rose-400 inline-block" />
                Ingresos
              </span>
              <span className="flex items-center gap-1.5">
                <span className="h-2 w-4 rounded-full bg-violet-400 inline-block" />
                Usuarios
              </span>
            </div>
          </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-6 py-5 border-b border-white/8">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="self-start sm:self-auto px-3 py-1.5 rounded-lg border border-rose-500/30 bg-rose-500/15 text-rose-300 text-xs font-medium hover:bg-rose-500/25 transition-all duration-200"
            >
              Ver todas
            </motion.button>
          </div>
